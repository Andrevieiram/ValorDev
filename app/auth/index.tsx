      ...
      <View className="items-center justify-center py-8 gap-8">
        ...
        <View className="items-center gap-3">
          ...
          >
            ...
            <Text className="text-[10px] tracking-widest text-primary uppercase" style={{ fontFamily: 'Inter_700Bold' }}>
          ...
          <Animated.Text 
            ...
            style={{ color: '#ffffff', opacity: 0.85, fontFamily: 'Inter_300Light' }}
          >
            A ferramenta definitiva de precificação e análise de risco para freelancers.
          </Animated.Text>
        </View>
