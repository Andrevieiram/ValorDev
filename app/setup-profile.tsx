...
export default function SetupProfileScreen() {
  ...
  const handleSaveProfile = async (values: WizardProfileFormValues) => {
    try {
      ...
      Alert.alert(
        'Erro',
        'Não foi possível sincronizar seu perfil com o servidor. Tente novamente.'
      );
    }
  };
            ...
            <View className="gap-6 pb-8 pt-8">
              <View className="gap-2">
                ...
                <Text className="text-sm leading-6 text-muted-foreground">
                  Informe sua rotina, stack de especialidade e regime tributário. Isso será a base
                  global para todos os seus cálculos de projetos.
                </Text>
              </View>
                ...
                <View className="flex-row gap-2">
                  {EXPERIENCE_LEVEL_OPTIONS.map((option) => {
                    ...
                    return (
                      ...
                      >
                        <Text
                          className={cn('text-sm', isActive ? 'text-white' : 'text-foreground')}
                          style={{
              ...
              <View className="gap-3 pt-2">
                ...
                <Button
                  size="md"
                  variant="ghost"
                  label={profile.desiredIncome ? 'Cancelar e Voltar' : 'Configurar depois'}
                  onPress={() => {
