...
const registerSchema = z.object({
  name: z.string().nonempty("Nome é obrigatório").min(3, "O nome deve ter no mínimo 3 caracteres"),
    ...
    <AuthContainer>
      <View className="gap-6">
        ...
        <View className="flex-row justify-center items-center gap-1.5 pt-4">
          <Text className="text-xs" style={{ color: '#94a3b8' }}>Já possui uma conta?</Text>
