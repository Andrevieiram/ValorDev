    ...
    <ScreenContainer maxWidth="wizard" className="justify-between pb-8">
      <View className="gap-6">
        ...
        <View className="gap-3">
          <Text className="text-3xl text-foreground" style={{ fontFamily: 'Inter_800ExtraBold' }}>
          ...
          >
            Um fluxo guiado para estimar o valor de seus projetos de software com clareza e
            precisão.
          </Text>
        </View>
