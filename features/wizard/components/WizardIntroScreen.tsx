...
export function WizardIntroScreen() {
  ...
  return (
    <ScreenContainer>
      <Text className="text-2xl font-semibold text-foreground mb-2">Wizard de precificação</Text>
      ...
      <Card variant="outlined" className="mb-6">
        <Text className="text-sm text-muted-foreground">
          Estado global em Zustand (`useWizardStore`). Dados do formulário serão conectados com
          React Hook Form na próxima etapa.
        </Text>
      </Card>
